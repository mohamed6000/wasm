...
typedef unsigned long long GLuintptr;
...
void webglBindAttribLocation(GLuint program, GLint index, const char *name_pointer, GLint name_count);
void webglBindBuffer(GLenum target, GLuint buffer);
void webglBindFramebuffer(GLenum target, GLuint framebuffer);
void webglBindTexture(GLenum target, GLuint texture);
void webglBlendColor(GLclampf r, GLclampf g, GLclampf b, GLclampf a);
void webglBlendEquation(GLenum mode);
void webglBlendFunc(GLenum source_factor, GLenum dest_factor);
void webglBlendFuncSeparate(GLenum src_rgb, GLenum dest_rgb, GLenum src_factor, GLenum dest_factor);
void webglBufferData(GLenum target, GLsizeiptr size, const void *data, GLenum usage);
void webglBufferSubData(GLenum target, GLintptr offset, GLsizeiptr size, const void *data);
...
void webglCompressedTexImage2D(GLenum target, GLint level, GLenum internal_format, GLint width, GLint height, GLint border, GLintptr image_size, const void *data);
void webglCompressedTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint width, GLint height, GLenum format, GLintptr image_size, const void *data);
void webglCopyTexImage2D(GLenum target, GLint level, GLenum internal_format, GLint x, GLint y, GLint width, GLint height, GLint border);
void webglCopyTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLint width, GLint height);
...
void webglDepthFunc(GLuint func);
void webglDepthMask(GLboolean flag);
void webglDepthRange(GLfloat near_z, GLfloat far_z);
void webglDetachShader(GLuint program, GLuint shader);
void webglDisable(GLuint cap);
void webglDisableVertexAttribArray(GLint index);
void webglDrawArrays(GLenum mode, GLint first, GLint count);
void webglDrawElements(GLenum mode, GLint count, GLenum type, void *indices);
void webglEnable(GLuint cap);
void webglEnableVertexAttribArray(GLint index);
void webglFinish(void);
void webglFlush(void);
void webglFramebufferRenderbuffer(GLenum target, GLenum attachement, GLenum renderbuffer_target, GLuint renderbuffer);
void webglFramebufferTexture2D(GLenum target, GLenum attachement, GLenum textarget, GLuint texture, GLint level);
void webglFrontFace(GLenum mode);
void webglGenerateMipmap(GLenum target);
GLint webglGetAttribLocation(GLuint program, const char *name_pointer, GLint name_count);
GLint webglGetParameter(GLenum pname);
GLint webglGetProgramParameter(GLuint program, GLenum pname);
void webglGetProgramInfoLog(GLuint program, GLsizei max_length, GLsizei *length, char *info_log);
void webglGetShaderInfoLog(GLuint shader, GLsizei max_length, GLsizei *length, char *info_log);
void webglGetShaderiv(GLuint shader, GLenum pname, GLint *p);
GLint webglGetUniformLocation(GLuint program, const char *name_pointer, GLint name_count);
GLuintptr webglGetVertexAttribOffset(GLint index, GLenum pname);
void webglHint(GLenum target, GLenum mode);
GLboolean webglIsBuffer(GLuint buffer);
GLboolean webglIsEnabled(GLenum cap);
GLboolean webglIsFramebuffer(GLuint framebuffer);
GLboolean webglIsProgram(GLuint program);
GLboolean webglIsRenderbuffer(GLuint renderbuffer);
GLboolean webglIsShader(GLuint shader);
GLboolean webglIsTexture(GLuint tex);
void webglLineWidth(GLfloat width);
void webglLinkProgram(GLuint program);
void webglPixelStorei(GLenum pname, GLint param);
void webglPolygonOffset(GLfloat factor, GLfloat units);
void webglReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, void *data);
...
void webglStencilMaskSeparate(GLenum face, GLuint mask);
void webglStencilOp(GLenum fail, GLenum zfail, GLenum zpass);
void webglStencilOpSeparate(GLenum face, GLenum fail, GLenum zfail, GLenum zpass);
void webglTexImage2D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const void *data);
void webglTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void *pixels);
void webglTexParameterf(GLenum target, GLenum pname, GLfloat param);
void webglTexParameteri(GLenum target, GLenum pname, GLint param);
void webglUniform1f(GLint location, GLfloat v0);
void webglUniform2f(GLint location, GLfloat v0, GLfloat v1);
void webglUniform3f(GLint location, GLfloat v0, GLfloat v1, GLfloat v2);
void webglUniform4f(GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
void webglUniform1i(GLint location, GLint v0);
void webglUniform2i(GLint location, GLint v0, GLint v1);
void webglUniform3i(GLint location, GLint v0, GLint v1, GLint v2);
void webglUniform4i(GLint location, GLint v0, GLint v1, GLint v2, GLint v3);
void webglUniform2fv(GLint location, GLsizei count, const GLfloat *value);
void webglUniform3fv(GLint location, GLsizei count, const GLfloat *value);
void webglUniform4fv(GLint location, GLsizei count, const GLfloat *value);
void webglUseProgram(GLuint program);
void webglValidateProgram(GLuint program);
void webglVertexAttrib1f(GLint index, GLfloat x);
